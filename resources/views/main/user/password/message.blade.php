                ...
                <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" width="100%"
                                            ...
                                            <tr>
                                                <td align="left" class="center-text">
                                                    {{-- <a href="{{ url('/') }}"><img
                                                            ...
                                                            src="{{ asset('../../../../../images/moneysign.png') }}"
                    ...
                    <tr>
                        <td class="center-text" align="center"
                            ...
                            <div>
                                <h1 style="text-align:center;"> Verify Your
                                    Email Address by clicking the link below</h1>
                            </div>
                            ...
                            <table border="0" cellspacing="0" cellpadding="0" role="presentation" align="center"
                                ...
                                <tr>
                                    <td align="center">
                                        ...
                                        <button target="_blank" style="font-family:'Roboto Slab',Arial,Helvetica,sans-serif;font-size:16px;line-height:19px;
                                                        font-weight:700;font-style:normal;color:#000000;text-decoration:none;letter-spacing:0px;
                                                        padding: 20px 50px 20px 50px;display: inline-block;">
                                            <span>Farm minning</span></button>
                                ...
                                <div class="row justify-content-center">
                                    <div class="col-md-8">
                                        <div class="card">
                                            <div class="card-header" style="color: #444; font-size:bold">

                                                <a style="font-family:'Roboto Slab',Arial,Helvetica,sans-serif;font-size:16px;line-height:19px;
                                                font-weight:700;font-style:normal;color:#74b9ff;text-decoration:none;letter-spacing:0px;
                                                padding: 20px 50px 20px 50px;display: inline-block"
                                                    href=" {{ route('user.reset', $reset_code) }}">Click Here</a>.
                                            </div>

                                            <p>href="{{ route('user.reset', $reset_code) }}">Click Here</a></p>
